...
float MTCNN::getRnetScore(ncnn::Mat& ncnn_img, Bbox& bbox)
{
	ncnn::Mat tmpMat,in;
	copy_cut_border(ncnn_img, tmpMat, bbox.y1, ncnn_img.h - bbox.y2,
		bbox.x1, ncnn_img.w - bbox.x2);
	resize_bilinear(tmpMat, in, 24, 24);
